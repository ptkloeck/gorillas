...
public class Gorilla extends ImageDestructibleGameObject {
   ...
   *          The relative position as <em>Vector2(x, y)</em> where the shot starts. Relative means
   *          here releative to the position of the gorilla entity.
   * 
   * @see {@link Shot.Direction}
   */
  public Gorilla(Vector2 position, Pixmap original, Pixmap destructionPattern,
      String destructionPatternID, Direction direction, Vector2 shotStartPosition) {
